...
## 4. 环境变量
新增或推荐：
- `EASYSHIFT_LLM_VENDOR`
- `EASYSHIFT_LLM_BASE_URL`
- `EASYSHIFT_LLM_API_KEY`
- `EASYSHIFT_LLM_MODEL_PARSER`
- `EASYSHIFT_LLM_MODEL_GENERATOR`
- `EASYSHIFT_LLM_MODEL_CRITIC`
- `EASYSHIFT_LLM_TIMEOUT_SEC`
